...
const styles = StyleSheet.create({
  ...
  overlay: {
    flex: 1,
    backgroundColor: "transparent", // Removed transparency
  },
  title: {
    marginTop: 16,
    marginHorizontal: 16,
  ...
  cardTitle: {
    color: "black", // Set card title color to black
  },
  description: {
    marginTop: 8,
  ...
  inputContainer: {
    ...
    elevation: 5,
    backgroundColor: "#ffff", // White background for input area
  },
  input: {
    marginBottom: 12,
  },
